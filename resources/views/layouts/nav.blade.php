<nav class="top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-white">
    <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
        <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            ...
            <a class="text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-no-wrap capitalize text-gray-600"
        ...
        <div class="lg:flex flex-grow items-center bg-white lg:bg-transparent lg:shadow-none hidden"
            ...
            <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
                ...
                <li class="flex items-center">
                    <a class="lg:hidden  lg:hover:text-gray-300 text-gray-600 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                        href="{{ URL::to('/admin') }}">
                ...
                <li class="flex items-center">
                    <a class="lg:hidden  lg:hover:text-gray-300 text-gray-600 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                        href="{{ URL::to('/admin/url') }}">
                        <i class="fa fa-link fa-2x mr-2"></i> <span>Smart Urls</span>
                    </a>
                </li>
                <li class="flex items-center">
                    <a class="lg:hidden  lg:hover:text-gray-300 text-gray-600 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                ...
                <li class="flex items-center">
                    <a class="text-gray-600 hover:text-gray-800  px-3 py-4 lg:py-2 flex items-center text-xs capitalize font-bold"
                ...
                <li class="flex items-center">
                    <a href="{{ URL::to('/admin/logout') }}" @click.prevent="logout"
