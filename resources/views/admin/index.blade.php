            ...
            <div class="w-full lg:w-6/12 ml-auto mr-auto">
                <div class=" w-full flex justify-center">
                    ...
                    <small v-if="isAdding">editing...</small>
                        ...
                        <div class=" flex flex-wrap text-center ">
                            <button @click.prevent="updateLink(editLink.id)" class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" >
                                Edit Link
                            </button>
                    ...
                    <form v-else class="bg-white rounded  px-8 pt-6 pb-8 mb-4 mt-3">
                        <h3 class="text-center">Add A Link</h3>
                            ...
                            <div class=" flex flex-wrap text-center ">
                                <button @click.prevent="addLink" class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" >
                                    Add Link
                                </button>
                ...
                <div class="block lg:flex container mx-auto flex-wrap  ">
                    ...
                    <div class="w-full lg:w-6/12 container mx-auto  px-4 py-6" v-for="item in links" @key="item.id">
                        <div class="relative rounded shadow-lg hover:shadow-2xl text  bg-white break-words">
                        ...
                        <div class=" mx-auto  w-5/6  rounded-lg   "  style="background:{{auth()->user()->color->background_color}};min-height: 100vh">
                            ...
                            <small class="text-center text-gray-500"><small>@</small>{{auth()->user()->username}}</small>
                              ...
                              <div class="flex flex-col text-center pt-10 ">
                                   ...
                                   <a :href="item.link" class="bg-orange-600  px-4 py-2 mb-5 capitalize " type="button"  style=" background-color:{{auth()->user()->color->text_color}};color:{{auth()->user()->color->background_color}}; ">@{{item.name}}</a>
                                   </div>
