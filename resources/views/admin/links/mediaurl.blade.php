    ...
    <div class="container relative mx-auto" id="linkpage">
        ...
        <div class=" block lg:flex ">
            ...
            <div class="w-full lg:w-6/12 ml-auto mr-auto">
                ...
                <div class="w-full border-l-4 border-green-600 shadow-2xl h-screen lg:mt-5  rounded-lg  ml-auto mr-auto lg:w-8/12" style="background:{{auth()->user()->color->background_color}}" >
                    <div class="relative flex flex-col justify-center">
                        
                        <div class=" w-full h-32  bg-center bg-cover  bg-no-repeat" style='background-image: url("{{auth()->user()->banner==NULL?URL::asset('img/back2.jpg'):auth()->user()->banner}}");'>
                            <div class=" flex justify-center text-center ">
                                <img class="h-20 w-20  rounded-full align-middle m-20 ml-20 lg:ml-20" src="{{auth()->user()->picture==NULL?URL::asset('img/user.png'):auth()->user()->picture}}"  alt="">
                            </div>
                        </div>
                    ...
                    <div class="container mx-auto ">
                        <div v-for="item in links" @key="item.id" >
                            <div class="px-4 py-2 border-b-4 w-10/12 mx-auto border-green-600 rounded  mb-4 " style=" background-color:{{auth()->user()->color->text_color}};color:{{auth()->user()->color->background_color}}; ">
